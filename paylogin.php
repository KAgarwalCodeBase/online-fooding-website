...
<!--"https://www.sandbox.paypal.com/cgi-bin/webscr"-->
       ...
       <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post"  class="contact-form" style="" >
        
<input type="hidden" name="cmd" value="_cart">
<input type="hidden" name="upload" value="1">
<input type="hidden" name="business" value="fakebusiness1997@gmail.com">
<input type="hidden" name="item_name_1" value="abc" id="showplan1">
<input type="hidden" name="amount_1" value="100" id="showplan2">
<input type="hidden" name="return" id="showplan3" value="" >
<input type="hidden" name="cancel_return" value="http://localhost/omnifood/returncancle.php" >
...
<div class="col span-1-of-3">
    ...
    <div>
        ...
        <button class="Signup"   type="button"   onclick="showlogin1();"   >SELECT</button>     
    </div>
    </div>   
</div>
...
<div class="plan-box">
    ...
    <div>
        <button class="Signup"  type="button"   onclick="showlogin2();" >SELECT</button>     
...
<div class="col span-1-of-3">
    ...
    <div>
        ...
        <button class="Signup" type="button"   onclick="showlogin3();">SELECT</button>     
